...
function Login() {
  ...
  return (
    <>
      ...
      <p id="heading">Login to start your journey</p>
      <div className="field">
        ...
        <input type="text" autoComplete="off" onChange={(e)=>{setEmail(e.target.value)}} placeholder="Username" className="input-field" />
      </div>
      <div className="field"> 
        <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
