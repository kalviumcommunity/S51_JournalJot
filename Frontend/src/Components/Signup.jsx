...
function Signup() {
  ...
  <form className="form" onSubmit={handleSubmitbtn}>
    ...
    <div className="field">
      ...
      <input autoComplete="off" placeholder="Name"  onChange={handleNameChange} className="input-field" type="text" />
    </div>
    <div className="field">
      <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      ...
      <input autoComplete="off" placeholder="Email"  onChange={(e)=>{setEmailId(e.target.value)}} className="input-field" type="email" />
    </div>
    <div className="field">
      <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
